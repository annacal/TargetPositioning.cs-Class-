...
/*
 * Namespace:   _323Project2
 * Class:       TargetPositioning
 * Author:      Anna Calvert
 * Functions:   public double CalculateTheta(double x = 10.0, double y = 10.0)  //theta = from missile launcher, the angle between the camera and the target.
 *              public double CalculatePhi(double x = 10.0, double y = 10.0)    //phi   = from missile launcher, the angle between the x-axis and the target.
 */
namespace _323Project2
{
    class TargetPositioning
